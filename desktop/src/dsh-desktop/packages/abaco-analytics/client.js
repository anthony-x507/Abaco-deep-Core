window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    // so no `require('./lib/…')` may appear in this bundle. A relative
    // require throws:
    //   client-modules: require("./lib/summary.js") missed the module table
    // and takes the whole plugin tree to Startup recovery / Safe Mode.
    // Keep lib/summary.js for Node tests; keep this copy in sync.
    // ══════════════════════════════════════════════════════════════════════
