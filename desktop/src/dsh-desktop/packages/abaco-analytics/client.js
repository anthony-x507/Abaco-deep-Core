window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    // The factory require is client-modules makeRequire, not Node:
    // seed word → strip trailing "/client" → loadCache → registered factory.
    // Relative "./lib/summary.js" and the package export "abaco-analytics/lib/summary"
    // are none of those, so they miss the module table even when the file is on disk
    // and package.json lists "./lib/summary". Node tests keep importing lib/summary.js.
